...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#FDFDFD] font-[family-name:var(--font-geist-sans)] selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <section className="relative pt-32 pb-32 overflow-hidden bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="max-w-6xl mx-auto">
            <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-slate-200 text-indigo-600 text-[11px] font-bold uppercase tracking-wider mb-8 shadow-sm hover:shadow transition-shadow cursor-default">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-20">
              ...
              <Link href="/developer/playground" className="inline-flex items-center justify-center px-8 py-3.5 border border-slate-200 text-base font-bold rounded-lg text-slate-700 bg-white hover:bg-slate-50 shadow-sm hover:border-slate-300 transition-all duration-200 group">
                <span className="font-mono text-indigo-600 mr-2 font-bold group-hover:translate-x-0.5 transition-transform">&gt;_</span> Open Simulator
              </Link>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] overflow-hidden border border-slate-200 text-left font-mono text-sm relative group mt-12">
            ...
            <div className="p-8 text-slate-600 space-y-4 leading-relaxed bg-white/80 backdrop-blur-xl">
              ...
              <div className="space-y-2">
                ...
                <div className="pl-6 pb-2">
                  ...
                  <span className="text-indigo-500 hover:text-indigo-600 hover:underline cursor-pointer transition-colors">wss://api.nexus.os/v1/stream...</span>
                </div>
              </div>

              <div className="pl-6 border-l-2 border-indigo-100 ml-1 py-2 space-y-3">
                <div className="flex items-start gap-3 text-[13px]">
                  <span className="text-indigo-600 font-bold text-[10px] bg-indigo-50 px-1.5 py-0.5 rounded border border-indigo-100 mt-0.5">INFO</span>
            ...
            <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-indigo-500/5 to-purple-500/5 blur-3xl rounded-full -translate-y-1/2 translate-x-1/2 pointer-events-none" />
          </div>
        </div>
      </section>
          ...
          <div className="relative">
            ...
            <div className="relative flex flex-col md:flex-row gap-8 mb-20 group">
              <div className="md:w-14 flex-shrink-0 flex flex-col items-center relative z-10">
                <div className="w-14 h-14 rounded-full bg-white border-2 border-indigo-100 text-indigo-600 font-bold text-xl flex items-center justify-center shadow-sm group-hover:border-indigo-600 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300">
                  1
                </div>
              </div>
              <div className="flex-1 bg-white p-8 rounded-2xl border border-slate-200 shadow-sm group-hover:shadow-xl group-hover:border-indigo-100 transition-all duration-300">
                <div className="flex items-start gap-6">
                  <div className="w-16 h-16 bg-indigo-50 rounded-xl flex items-center justify-center shrink-0 text-indigo-600">
                  ...
                  <div>
                    ...
                    <Link href="/integration-hub" className="text-indigo-600 font-bold text-sm hover:underline">
