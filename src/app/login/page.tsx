    ...
    return (
        <div className="min-h-screen flex font-[family-name:var(--font-geist-sans)]">
            ...
            <div className="hidden lg:flex lg:w-[48%] relative bg-gradient-to-br from-slate-100 via-slate-50 to-white flex-col justify-between p-10 overflow-hidden">
                ...
                <div className="absolute top-0 right-0 w-full h-72 bg-gradient-to-b from-blue-100/40 to-transparent pointer-events-none" />
                ...
                <div className="relative z-10">
                    ...
                    >
                        <div className="w-11 h-11 bg-blue-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-200 transition-all duration-300 group-hover:scale-110 group-hover:shadow-xl group-hover:shadow-blue-300 group-hover:rounded-2xl">
                ...
                <div className="relative z-10">
                    <h2 className="text-[2.6rem] leading-tight font-light text-slate-800 tracking-tight">
                        ...
                        <span className="italic font-normal text-blue-600">future of supply.</span>
                    </h2>
                    {/* Carousel dots */}
